    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground">Process and manage customer refunds</p>
        </div>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Manage all refund requests and approvals</CardDescription>
        </CardHeader>
        <CardContent>
          <p className="text-muted-foreground">No pending refund requests at the moment.</p>
        </CardContent>
      </Card>
    </div>
  );
